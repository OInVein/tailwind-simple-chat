...
const SendButton = () => {
  ...
  return (
    <div
      className="
        w-12 h-12 motion-safe:hover:scale-110 transition text-xs cursor-pointer bottom-0 right-0 absolute bg-orange-400 rounded-lg flex justify-center items-center
